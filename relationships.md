...
~~~
    ...
    11. Click the Create Relationship button
~~~
...
Congrats! Your app now contains all the data from Drew’s spreadsheets. Click on the `Line Items` table in the table nav and review that everything looks correct.
